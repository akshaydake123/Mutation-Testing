package com.akshaydake.pitest;

import java.util.List;

public class TicketPriceCalculator {

    private static int ADULT_AGE_BUS = 18;
    private static int FREE_TICKET_AGE_BELOW_BUS = 3;
    ...
    t arr[0...n-1] */
     int[] mergeSortBus(int arr[], int n) 
    { 
	...
	/* Iterative mergesort function to sor 
    t arr[0...n-1] */
     int[] mergeSortTrain(int arr[], int n) 
    { 
	...
	/* Iterative mergesort function to sor 
    t arr[0...n-1] */
     int[] mergeSortAirPlane(int arr[], int n) 
    { 
	...
	/* Iterative mergesort function to sor 
    t arr[0...n-1] */
     int[] mergeSortTaxi(int arr[], int n) 
    { 
	...
	/* Iterative mergesort function to sor 
    t arr[0...n-1] */
     int[] mergeSortMovie(int arr[], int n) 
    { 
	...
	/* Iterative mergesort function to sor 
    t arr[0...n-1] */
     int[] mergeSortShip(int arr[], int n) 
    { 
	...
	/* Iterative mergesort function to sor 
    t arr[0...n-1] */
     int[] mergeSortPark(int arr[], int n) 
    { 
